import { TrackedAsteroid } from './findBestAsteroidForMonitoringStation'
 ...
 */
export const calculateVaporization = (
	asteroids: TrackedAsteroid[],
): TrackedAsteroid[] => {
	...
	const poa = [target] as TrackedAsteroid[]
