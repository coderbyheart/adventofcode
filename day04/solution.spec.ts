...
describe('Day 4: Passport Processing', () => {
	...
	describe('Part 2', () => {
		it('should solve the invalid passports sample', () => {
			expect(
				parsePassportList(
		...
		it('should solve the valid passports sample', () => {
			expect(
				parsePassportList(
					loadString(`pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
						hcl:#623a2f
