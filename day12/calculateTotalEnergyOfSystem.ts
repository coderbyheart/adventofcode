 ...
 */
const calculateTotalEnergyOfMoon = ({ pos, vel }: Moon) => sumAbsolute(pos) * sumAbsolute(vel)

export const calculateTotalEnergyOfSystem = (galaxy: Moon[]): number => galaxy
    .reduce((totalEnergy, moon) => totalEnergy + calculateTotalEnergyOfMoon(moon), 0)